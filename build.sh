...
mkdir Build
cd Build
cmake .. -DCMAKE_SYSTEM_NAME=Android -DCMAKE_ANDROID_ARCH_ABI=arm64-v8a -DCMAKE_SYSTEM_VERSION=21 -DCMAKE_ANDROID_NDK_TOOLCHAIN_VERSION=$NTV -DCMAKE_ANDROID_NDK=$NDKROOT -DCMAKE_ANDROID_STL_TYPE=$STL -DCMAKE_BUILD_TYPE=Release -DANDROID_ABI=arm64-v8a
make -j4
make install